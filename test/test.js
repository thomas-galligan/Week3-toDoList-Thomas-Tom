...
test("Testing sortByDate()", t => {
    ...
    t.deepEqual(
        actual,
        expected,
        "sortByDate() should return the opposite order of the objects in the array."
    );
    t.end();
});
...
test("Testing sortByStatus()", t => {
    ...
    t.deepEqual(
        actual,
        expected,
        "sortByStatus() should return the opposite order of the objects in the array."
    );
    t.end();
});
...
test("Testing addItem()", t => {
    ...
    t.deepEqual(
        actual,
        expected,
        "addItem() should generate a new object and append it to the arr."
    );
    t.end();
});
...
test("Testing addItem()", t => {
    ...
    t.deepEqual(
        actual,
        expected,
        "addItem() increases the length of arr by 1."
    );
    t.end();
});
...
test("Testing deleteItem()", t => {
    ...
    t.deepEqual(
        actual,
        expected,
        "deleteItem() should delete an item from arr."
    );
    t.end();
});
...
test("Testing deleteItem()", t => {
    ...
    t.deepEqual(
        actual,
        expected,
        "deleteItem() should decrease the length of arr by 1."
    );
    t.end();
});
...
test("Testing changeStatus()", t => {
    ...
    t.deepEqual(
        actual,
        expected,
        "changeStatus() should change the status of arr to false."
    );
    t.end();
});
